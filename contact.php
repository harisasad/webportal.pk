		...
		<section class="row top_header pt-3">
			<div class="col-lg-6">
				...
				<div class="col-lg-6 buttons">
					<p><i class="fas mr-1 fa-phone"></i> +92 8976092334</p>
	...
	<div class="container py-sm-3">
			...
			<div class="col-md-4 address-grid">
				<div class="address-info">
					...
					<div class="address-right text-center">
						...
						<p> 2466H 5th Street Parking, King Block, Lahore City.
				...
				<div class="address-info">
					...
					<div class="address-right text-center">
						<h6 class="ad-info text-uppercase mb-2">Email</h6>
							<a href="mailto:example@email.com"> harisasad706@gmail.com</a>
		...
		<div class="form row py-5">
			<div class="col-lg-6 contact-form">
				<form role="form" name="myForm" action="cont.php" method="POST">
