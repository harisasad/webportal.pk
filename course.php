		...
		<section class="row top_header pt-3">
			<div class="col-lg-6">
				...
				<div class="col-lg-6 buttons">
					<p><i class="fas mr-1 fa-phone"></i> +92 8976 2334</p>
		...
		<nav class="navbar navbar-expand-lg navbar-light py-sm-4 py-2">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-lg-auto text-center">
					...
					<li class="dropdown nav-item active mr-lg-3">
		...
		<div class="row course-grids">
			...
			<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
				<div class="card">
				  ...
				  <div class="card-body">
					<h5 class="card-title">Art Course</h5>
					<p class="card-text mb-3">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
					<a href="contact.php" class="btn btn-primary"><i class="fas fa-graduation-cap"></i> Join Course</a>
				  </div>
				</div>
			...
			<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
				<div class="card">
				  ...
				  <div class="card-body">
					<h5 class="card-title">Library Course</h5>
					<p class="card-text mb-3">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
					<a href="contact.php" class="btn btn-primary"><i class="fas fa-graduation-cap"></i> Join Course</a>
				  </div>
				</div>
			...
			<div class="col-lg-4 col-md-6 mt-5">
				<div class="card">
				  <img class="card-img-top" src="images/image2.jpg" alt="Card image cap">
				  <div class="card-body">
					<h5 class="card-title">Designing Course</h5>
					<p class="card-text mb-3">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
					<a href="contact.php" class="btn btn-primary"><i class="fas fa-graduation-cap"></i> Join Course</a>
				  </div>
				</div>
			...
			<div class="col-lg-4 col-md-6 mt-5">
				<div class="card">
				  <img class="card-img-top" src="images/image1.jpg" alt="Card image cap">
				  <div class="card-body">
					<h5 class="card-title">Abroad Courses</h5>
					<p class="card-text mb-3">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
					<a href="contact.php" class="btn btn-primary"><i class="fas fa-graduation-cap"></i> Join Course</a>
				  </div>
				</div>
