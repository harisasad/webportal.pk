...
<?php
		...
		$mysqli = new mysqli('localhost','root','','webportal') or die (mysqli_error($mysqli));
		...
		<section class="row top_header pt-3">
			<div class="col-lg-6">
				...
				<div class="col-lg-6 buttons">
					<p><i class="fas mr-1 fa-phone"></i> +923024885431</p>
	...
	<div class="container">
		<div class="banner-text">
			<div class="slider-info mb-4">
				...
				<a href="course.php" class="mr-2"><i class="fas fa-graduation-cap"></i> Our Courses</a>
...
<footer>
		...
		<div class="row footer-gap">
			<div class="col-lg-3 col-sm-6">
				...
				<address class="mb-0">
					...
					<p class="mb-3"><i class="fas fa-map-marker"></i> 2466H 5th Street Parking, King <br>Block, Lahore City.</p>
					<p><i class="fas fa-clock"></i> Timings : 10 a.m to 6 p.m</p>
					<p><i class="fas fa-phone"></i> +92 8976 2334</p>
					<p><i class="fas fa-envelope-open"></i> <a href="mailto:info@example.com">harisasad706@gmail.com</a></p>
					<p><i class="fas fa-fax"></i> +92 8976 2334 </p>
				</address>
			</div>
	...
	<div class="copyright pb-5 text-center">
		<!-- <p>© 2018 Eduversity. All Rights Reserved | Design by <a href="" target="_blank"></a></p> -->
	</div>
</footer>
<!-- footer -->
<!-- Login modal -->
				...
				<div class="modal-body">
					<form action="#" method="post" class="p-3">
						<div class="form-group">
							...
							<input type="email" class="form-control" placeholder="User Name" name="email" id="recipient-name" required="">
						</div>
						<div class="form-group">
	...
	<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form  role="form" name="myForm" action="reg.php" method="POST" class="p-3">
						<input type="hidden" name="id" value="<?php echo $id; ?>">
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">First Name</label>
							<input type="text" class="form-control" placeholder="First Name" name="fname" value="<?php echo $fname ?>" id="recipient-name2" required="">
						</div>
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">Last Name</label>
							<input type="text" class="form-control" placeholder="Last Name" name="lname" value="<?php echo $lname ?>" id="recipient-name3" required="">
						</div>
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">Email id</label>
							<input type="email" class="form-control" placeholder="Email id" name="email" value="<?php echo $email ?>" id="recipient-name4" required="">
						</div>
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">Mobile Number</label>
							<input type="text" class="form-control" placeholder="Mobile Number" name="mobile" value="<?php echo $mobile ?>" id="recipient-name5" required="">
						</div>
						<div class="form-group">
							<label for="recipient-name1" class="col-form-label">Password</label>
							<input type="password" class="form-control" placeholder="Password" name="pass" value="<?php echo $pass ?>" id="recipient-name6" required="">
						</div>
						<div class="right-w3l mt-4 mb-3">
							<div class="col-md-6 align-self-end">
										...
										<?php else:?>
										<button type="submit" class="btn btn-primary" name="save">Create An Account</button>
										<?php endif; ?>
					                  </div>
						</div>
					</form>
